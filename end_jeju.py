...
# Set the title
fig17.update_layout(title_text="Time series of food consumption behavior")
...
pages = [
    ...
    Page("데이터 소개", 
         ...
         df_titles=["제주 동반자 유형별 여행 계획 데이터2023", "제주 동반자 유형별 여행 계획 데이터2023",
                    "SNS 제주 관광 키워드별 수집 통계_월(22~23)", "제주 관광수요예측 데이터_비짓제주 로그 데이터 월2023",
                    "제주관광공사 관광 소비행태 데이터 카드사 음식 급상승 데이터(21~23)_수정", "제주관광공사 관광 소비행태 데이터 카드사 음식 급상승 데이터(21~23)_수정",
